...
$adminsor=$db->prepare("SELECT * FROM user where admin_id=:id and admin_kullanici=:kullanici and admin_parola=:parola");
$adminsor->execute(array(
    ...
    'parola'=>$admin_parola
      ...
      $usercek=$adminsor->fetch(PDO::FETCH_ASSOC);
      $kontrol=$adminsor->rowCount();
...
<head>
    ...
    <title>Özgür Medya - Giriş Yap</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="ayarlar/islem.php" method="post">
                                        <div class="form-group">
                                            <input type="text" name="admin_kullanici" class="form-control form-control-user"
