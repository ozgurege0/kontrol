...
$vericek=$how->fetch(PDO::FETCH_ASSOC);
               ...
               ?>
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <h2><b>"Nasıl Kullanılır" Sayfası</b></h2>

                        <form action="ayarlar/islem.php" method="post">
                        <label class="mt-3">Yazı Başlığı</label>
                        <input type="text" class="form-control" name="how_baslik" value="<?php echo $vericek['how_baslik'] ?>">

                        <label class="mt-3">Yazı</label>
                        <textarea id="summernote" name="how_yazi"><?php echo $vericek['how_yazi']?></textarea>

                        <button class="btn btn-primary mt-3" name="howkaydet">KAYDET</button>
                        </form>
                    </div>
