               ...
               ?>
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="lisanslar_ad">

                        <label class="mt-3">Ürün Kodu</label>
                        <input type="text" class="form-control" name="lisanslar_kod">

                        <button class="btn btn-primary mt-3" name="productekle">EKLE</button>
                        </form>
                    </div>
