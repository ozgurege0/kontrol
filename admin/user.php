               ...
               ?>
                ...
                <div class="container">
                    ...
                    <div class="col-md-12">
                        ...
                        <label class="mt-3">Admin Kullanıcı Adı:</label>
                        <input type="text" class="form-control" name="admin_kullanici" value="<?php echo $vericek['admin_kullanici'] ?>">

                        <button class="btn btn-primary mt-3" name="userkaydet">KAYDET</button>
                        </form>
                        <br><br><br><br><br>
                        <form action="ayarlar/islem.php" method="post">

<label class="mt-3">Yeni Admin Şifresini Girebilirsiniz:</label>
<input type="text" class="form-control" name="admin_parola" >

<button class="btn btn-primary mt-3" name="userkaydet1">KAYDET</button>
</form>
